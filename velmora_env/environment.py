...
class IncidentEnv:
    def __init__(self, task_name="easy"):
        ...
        self.tasks = {
            ...
            "hard": [
                {
                    "incident": "Payment processing system corrupted after failed migration",
                    "hint": "Transactions are being double-charged or lost",
                    "logs": "Database migration rollback failed; payment records inconsistent.",
                    "ideal_sequence": ["contain", "investigate", "escalate", "fix", "monitor"],
                    "requires_escalation": True,
                    "requires_containment": True,
                    "severity": "high"
                },
                {
                    "incident": "CDN configuration poisoned serving malicious content",
                    "hint": "Users reporting unexpected redirects and injected scripts",
                    "logs": "CDN edge nodes serving modified assets; origin integrity check failing.",
                    "ideal_sequence": ["contain", "investigate", "escalate", "fix", "monitor"],
                    "requires_escalation": True,
                    "requires_containment": True,
                    "severity": "high"
                ...
                {
                    "incident": "Kubernetes cluster node pool exhaustion under load",
                    "hint": "Pods failing to schedule, services degrading",
                    "logs": "Scheduler reports insufficient resources; pending pod queue growing.",
                    "ideal_sequence": ["investigate", "contain", "escalate", "fix", "monitor"],
                    "requires_escalation": True,
                    "requires_containment": True,
                    "severity": "high"
                },
                {
                    "incident": "Internal API keys leaked to public repository",
                    "hint": "Security scan detected exposed credentials",
                    "logs": "Secret scanning alert: production API keys found in public commit.",
                    "ideal_sequence": ["contain", "investigate", "escalate", "fix", "monitor"],
                    "requires_escalation": True,
                    "requires_containment": True,
                    "severity": "high"
